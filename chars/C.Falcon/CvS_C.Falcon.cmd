...
trigger10 = stateno = 990 && movecontact
trigger11 = stateno = 1030 && movecontact
;trigger2 = stateno = 200 || stateno = 210 || stateno = 230 || stateno = 240|| stateno = 400 || stateno = 410 || stateno = 430 || stateno = 520  || stateno = 1000 || stateno = 1030 
;trigger2 = movecontact
;trigger3 = stateno = 990 || stateno = 991 || stateno = 992
...
type=changestate
value=ifelse((var(1)=1 && power>=500 && random<100),1000,1150)
triggerall= var(59)>=1 && numenemy
triggerall= roundstate=2 && statetype!=A
...
triggerall= (enemynear,const(size.head.pos.y)<=-40) || (enemynear,statetype=A)
trigger1= ctrl && random<50
trigger2= (stateno=[200,250]) && stateno!=210 && movehit && random<200
...
trigger3= stateno=210 && (p2bodydist x=[0,20]) && movehit && random<200
...
trigger3= stateno=210 && anim=200 && animelemtime(26)>=0 && movehit && random<200

[State -1, HellLancer]
type=ChangeState
value=ifelse((var(1)=1&&power>=500&&random<133),1200,1000)
...
[State -1, RisingSun]
type=changestate
value=ifelse((var(1)=1&&power>=500&&random<100),1200,1150)
triggerall=var(59)>=1&&roundstate=2&&statetype!=A
triggerall=(p2stateno!=[120,155])&&(p2statetype!=L)
...
trigger3=ctrl&&var(1)!=1&&prevstateno=210&&random<150
