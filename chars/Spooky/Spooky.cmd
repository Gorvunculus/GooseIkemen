...
;Either one will be detected by a "command = 4 Machetes" trigger.
;Time is set to 20 (instead of default of 15) to make the move
;easier to do.
;
[Command]
name = "Specimen Spectacle"
...
[Command]
name = "4 Machetes"   ;Same name as above
command = ~D, DF, F, D, DF, F, y
time = 20
...
[Command]
name = "Specimen 9"   ;Same name as above
...
[Statedef -1]
;---------------------------------------------------------------------------
[State -1,AION];turns the AI on if there is an ailevel
Type = VarSet
TriggerAll = Var(59) = 0
Trigger1 = AILevel
V = 59
...
;---------------------------------------------------------------------------
[State -1,AIOFF];turns the AI off if there isnt an ailevel
Type = VarSet
Trigger1 = !AILevel
V = 59
Value = 0
...
type = ChangeState
value = 3100
triggerall = command = "Specimen Spectacle"
...
trigger1 = screenpos x < 20 && facing = 1
trigger2 = screenpos x > 300 && facing = -1
...
;===========================================================================
;Liedown Attack
[State -1, Liedown Attack]
type = ChangeState
value = 700
triggerall = enemy, statetype = L
triggerall = command = "Liedown Attack"
triggerall = statetype != A
;triggerall = var(10)
trigger1 = ctrl
trigger2 = stateno = 40
