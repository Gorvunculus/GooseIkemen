...
------------------------------------------------------------
selectRows = math.floor(selectColumns * 20 / 50.0)

setRandomSpr(sysSff, 151, 0, 50.0/selectColumns, 50.0/selectColumns)
setSelColRow(selectColumns, selectRows)
setSelCellSize(5*50.0/selectColumns, 5*50.0/selectColumns)
...
function p1SelSub()
  ...
  if not p1SelEnd then
    ...
    elseif p1SelY >= selectRows then
      p1SelOffset = p1SelOffset + selectColumns*(p1SelY - (selectRows - 20))
      p1SelY = selectRows - 1
    end
    if p1SelX < 0 then
    ...
    animUpdate(p1Cursor)
    animPosDraw(
      p1Cursor, 35 + 5*p1SelX*50.0/selectColumns,
      90 + 5*p1SelY*50.0/selectColumns)
...
function p2SelSub()
  ...
  if not p2SelEnd then
    ...
    elseif p2SelY >= selectRows then
      p2SelOffset = p2SelOffset + selectColumns*(p2SelY - (selectRows - 20))
      p2SelY = selectRows - 1
    end
    if p2SelX < 0 then
    ...
    animUpdate(p2Cursor)
    animPosDraw(
      p2Cursor, 35 + 5*p2SelX*50.0/selectColumns,
      90 + 5*p2SelY*50.0/selectColumns)
